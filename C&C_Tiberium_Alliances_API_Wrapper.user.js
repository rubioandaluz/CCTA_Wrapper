    ...
    try {
      function createCCTAWrapper() {
        ...
        if (typeof SharedLib.Combat == 'undefined') {
          ...
          try {
            SharedLib.Combat = SharedLib.MKLAOS ? SharedLib.MKLAOS : SharedLib.HFKQVP ? SharedLib.HFKQVP : null; //Might not work
          } catch (e) {
        ...
        if (typeof SharedLib.Combat.CbtSetup == 'undefined') {
          ...
          try {
            SharedLib.Combat.CbtSetup = SharedLib.XTJTVV ? SharedLib.XTJTVV : SharedLib.YUEBQC ? SharedLib.YUEBQC : null ; //Might not work
          } catch (e) {
        ...
        if (!SharedLib.Combat.CbtSimulation) {
          SharedLib.Combat.CbtSimulation = function() {
            try {
              SharedLib.Combat.CbtSimulation = SharedLib.PRFSNB ? SharedLib.PRFSNB : SharedLib.FBJZWE ? SharedLib.FBJZWE : SharedLib.QOL ? SharedLib.QOL : null;
            } catch (e) {
        ...
        if(!ClientLib.Vis.Battleground.BattlegroundEntity) {
          ClientLib.Vis.Battleground.BattlegroundEntity = System.MPWDBM ? System.MPWDBM : System.GMKMXN ? System.GMKMXN : System.GZJ ? System.GZJ : null;
        }
